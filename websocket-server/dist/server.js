...
app.all("/twiml", (req, res) => {
    try {
        ...
        res
            .status(500)
            .type("text/plain")
            .send("Server misconfigured. Set PUBLIC_URL to the externally reachable base URL (e.g. your ngrok https endpoint).");
    }
});
...
wss.on("connection", (ws, req) => {
    ...
    if (type === "call") {
        ...
        (0, sessionManager_1.handleFrontendConnection)(ws);
    }
    else {
        ws.close();
    }
